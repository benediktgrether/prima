...
(function (L14_FudgeCraftRecursive) {
    ...
    class Control extends ƒ.Node {
        ...
        checkCollisions(_transformation) {
            ...
            for (let cube of this.fragment.getChildren()) {
                let element = L14_FudgeCraftRecursive.grid.pull(cube.mtxWorld.translation);
                if (element)
        ...
        freeze() {
            ...
            for (let cube of this.fragment.getChildren()) {
                ...
                let element = new L14_FudgeCraftRecursive.GridElement(cube);
                L14_FudgeCraftRecursive.grid.push(position, element);
                frozen.push(element);
            }
            return frozen;
        }
    ...
    L14_FudgeCraftRecursive.Control = Control;
